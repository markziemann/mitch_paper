# Note: Much of the below code has been lifted from the Satija Lab Tutorial 
# https://satijalab.org/seurat/immune_alignment.html
# Which has been archive in wayback machine for posterity
# https://web.archive.org/web/20190329092345/https://satijalab.org/seurat/immune_alignment.html
...
cd4.naive.t <- SubsetData(immune.combined, ident.use = "CD4 Naive T", subset.raw = T)
cd4.naive.t <- SetAllIdent(cd4.naive.t, id = "stim")
